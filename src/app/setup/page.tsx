				...
				<section className="content-frame mx-auto max-w-245">
					<div className="legacy-stack">
						...
						<p>
							...
							&apos;s services can be utilized either by hosting
							manually or using the officially hosted services.
							These services such as InvisiProxy
							...
							<strong>
								<a
									...
									target="_blank"
								>
									<span className="tn-brand">TN</span> Discord
								</a>
							</strong>{" "}
						...
						<p>
							...
							from the <span className="tn-brand">TitaniumNetwork</span> discord.
						</p>
						<p>
							Example Mirror/URL:{" "}
						...
						<h3>Kajigs</h3>
						<p>
							A repository of methods/exploits (found in the <span className="tn-brand">TN</span> discord) 
							maintained by <span className="tn-brand">TitaniumNetwork</span> you can
						...
						<h3>Setup</h3>
						<p>
							If you wish to setup any of <span className="tn-brand">TitaniumNetwork</span>&apos;s
